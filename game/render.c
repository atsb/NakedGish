...
void renderobjects(void)
  ...
  for (count=0;count<numofobjectrenders;count++)
    ...
    if (objectrender[count].type==1)
      ...
      vec[0]=objectrender[count].vertex[32][0]+size*cos(objectrender[count].angle+M_PI/4.0f);
      vec[1]=objectrender[count].vertex[32][1]+size*sin(objectrender[count].angle+M_PI/4.0f);
      vec[2]=0.0f;
      ...
      vec[0]=objectrender[count].vertex[32][0]+size*cos(objectrender[count].angle+3.0f*M_PI/4.0f);
      vec[1]=objectrender[count].vertex[32][1]+size*sin(objectrender[count].angle+3.0f*M_PI/4.0f);
      vec[2]=0.0f;
      if (object[objectrender[count].objectnum].direction==0)
        glTexCoord2f(1.0f,0.0f);
      else
      ...
      vec[0]=objectrender[count].vertex[32][0]+size*cos(objectrender[count].angle+5.0f*M_PI/4.0f);
      vec[1]=objectrender[count].vertex[32][1]+size*sin(objectrender[count].angle+5.0f*M_PI/4.0f);
      vec[2]=0.0f;
      if (object[objectrender[count].objectnum].direction==0)
        glTexCoord2f(1.0f,1.0f);
      else
      ...
      vec[0]=objectrender[count].vertex[32][0]+size*cos(objectrender[count].angle+7.0f*M_PI/4.0f);
      vec[1]=objectrender[count].vertex[32][1]+size*sin(objectrender[count].angle+7.0f*M_PI/4.0f);
      vec[2]=0.0f;
      if (object[objectrender[count].objectnum].direction==0)
        glTexCoord2f(0.0f,1.0f);
      else
