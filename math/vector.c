...
float dotproduct(float *vec,float *vec2)
  {
  return(vec[0]*vec2[0]+vec[1]*vec2[1]+vec[2]*vec2[2]);
  }

void crossproduct(float *result,float *vec,float *vec2)
  {
...
void normalizevector(float *result,float *vec)
  {
...
void copyvector(float *result,float *vec)
  {
